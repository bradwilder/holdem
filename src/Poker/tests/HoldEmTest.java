...
import Poker.game.HoldEm.HoldEmState;
...
public class HoldEmTest extends TestCase
{
   ...
   public void testPotLimit()
   {
      ...
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 5, 80, 180, 50, "brenda\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 80, "Main Pot (80)");
      
      m_oHoldEm.Bet(90);
      assertTrue(brendaPlayer.getChips() == 1910);
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 0, 130, 350, 90, "brad\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 170, "Main Pot (170)");
      
      m_oHoldEm.Bet(90);
      assertTrue(bradPlayer.getChips() == 1910);
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 1, 120, 420, 80, "jeff\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 260, "Main Pot (260)");
      ...
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 2, 110, 400, 70, "matt\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 260, "Main Pot (260)");
      ...
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 3, 80, 340, 40, "mitch\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 260, "Main Pot (260)");
      
      m_oHoldEm.Bet(40);
      assertTrue(mitchPlayer.getChips() == 1910);
      verifyHoldEm(HoldEm.HoldEmState.DEAL_FLOP, 3, 0, 0, 0, "", 300, "Main Pot (300)");
      
      m_oHoldEm.deal();
      verifyHoldEm(HoldEm.HoldEmState.BET_FLOP, 3, 20, 300, 0, "mitch\nCheck or Open?", 300, "Main Pot (300)");
      
      m_oHoldEm.Check();
      assertTrue(mitchPlayer.getChips() == 1910);
      verifyHoldEm(HoldEm.HoldEmState.BET_FLOP, 5, 20, 300, 0, "brenda\nCheck or Open?", 300, "Main Pot (300)");
      
      m_oHoldEm.Bet(70);
      assertTrue(brendaPlayer.getChips() == 1840);
      verifyHoldEm(HoldEm.HoldEmState.BET_FLOP, 0, 140, 510, 70, "brad\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 370, "Main Pot (370)");
      
      m_oHoldEm.Bet(470);
      assertTrue(bradPlayer.getChips() == 1440);
      verifyHoldEm(HoldEm.HoldEmState.BET_FLOP, 3, 870, 1780, 470, "mitch\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 840, "Main Pot (840)");
      ...
      verifyHoldEm(HoldEm.HoldEmState.BET_FLOP, 5, 800, 1640, 400, "brenda\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 840, "Main Pot (840)");
      
      m_oHoldEm.Fold();
      assertTrue(brendaPlayer.getChips() == 1840);
      assertTrue(m_oHoldEm.getState() == HoldEm.HoldEmState.WINNER);
      ...
      verifyHoldEm(HoldEm.HoldEmState.BLINDS, 2, 0, 0, 10, "matt\nPost Small Blind Of " + m_oHoldEm.getCall() + "?", 0, "Main Pot (0)");
      
      m_oHoldEm.Bet(m_oHoldEm.getCall());
      assertTrue(mattPlayer.getChips() == 1970);
      verifyHoldEm(HoldEm.HoldEmState.BLINDS, 3, 0, 0, 20, "mitch\nPost Big Blind Of " + m_oHoldEm.getCall() + "?", 10, "Main Pot (10)");
      
      m_oHoldEm.Bet(m_oHoldEm.getCall());
      assertTrue(mitchPlayer.getChips() == 1890);
      verifyHoldEm(HoldEm.HoldEmState.DEAL_HOLES, 4, 0, 0, 0, "", 30, "Main Pot (30)");
      
      m_oHoldEm.deal();
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 4, 40, 70, 20, "dad\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 30, "Main Pot (30)");
      
      m_oHoldEm.Bet(20);
      assertTrue(dadPlayer.getChips() == 1980);
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 5, 40, 90, 20, "brenda\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 50, "Main Pot (50)");
      
      m_oHoldEm.Bet(20);
      assertTrue(brendaPlayer.getChips() == 1820);
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 0, 40, 110, 20, "brad\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 70, "Main Pot (70)");
      
      m_oHoldEm.Bet(20);
      assertTrue(bradPlayer.getChips() == 2260);
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 1, 40, 130, 20, "jeff\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 90, "Main Pot (90)");
      
      m_oHoldEm.Bet(20);
      assertTrue(jeffPlayer.getChips() == 1970);
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 2, 30, 130, 10, "matt\nCall " + m_oHoldEm.getCall() + ", Raise, or Fold?", 110, "Main Pot (110)");
      
      m_oHoldEm.Bet(10);
      assertTrue(mattPlayer.getChips() == 1960);
      verifyHoldEm(HoldEm.HoldEmState.BET_PREFLOP, 3, 20, 120, 0, "mitch\nOption: Check or Raise?", 120, "Main Pot (120)");
      
      m_oHoldEm.Check();
      assertTrue(mitchPlayer.getChips() == 1890);
      verifyHoldEm(HoldEm.HoldEmState.DEAL_FLOP, 4, 0, 0, 0, "", 120, "Main Pot (120)");
   ...
   private void verifyHoldEm(HoldEmState iGameState, int iActionPos, int iMinRaise, int iMaxRaise, int iCall, String sNextAction, int iTotalPotSize, String sPotsString)
   {
      ...
      assertTrue(m_oHoldEm.getMinRaise() == iMinRaise);
